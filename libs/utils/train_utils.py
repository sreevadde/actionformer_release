...
def train_one_epoch_ddp(
    ...
    """Training the model for one epoch with DDP (DistributedDataParallel).

    This is the DDP-aware version of train_one_epoch that properly handles
    multi-process training with rank-aware printing and logging.
